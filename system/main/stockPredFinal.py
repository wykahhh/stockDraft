...
from .stockpredict import True_pred
from .stockpredict import get_csv
from .stockpredict import load_logger
from .stockpredict import draw
from .stockpredict import Data
...
def predictApi(code):
    ...
    return True_pred(Config())

print(predictApi('sh600519'))